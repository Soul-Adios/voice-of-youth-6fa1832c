  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your anonymous message has been submitted and will appear on the dashboard.",
      });
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Your identity remains completely anonymous. Share your thoughts,
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              What's on your mind? Share your thoughts about society, your
              community, or any issues that matter to you.
            </CardDescription>
          </CardHeader>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-muted-foreground">
            🔒 Your submission is completely anonymous and cannot be traced back
            to you.
          </p>
        </div>
      </div>
